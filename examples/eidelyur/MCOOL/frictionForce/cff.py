...
rhoLarm_rhoCrit=rhoLarm_l[0,0]/rhoCrit_l[0,0];
...
plt.grid(True)
hold=True
plt.loglog(relVion_l,rhoLarm_rhoCrit*rhoCrit_l[:,0],'--k', \
       relVion_h,rhoLarm_rhoCrit*rhoCrit_h[:,0],'--k',linewidth=1)
plt.xlabel('Relative Ion Velocity, $V_i/V_{e0}$',color='m',fontsize=16)
# plt.ylabel('$R_{max}$ and $2\cdot<rho_\perp>$, cm',color='m',fontsize=16)
plt.ylabel('Impact Parameter, cm',color='m',fontsize=16)
titleHeader='Magnetized Collision: $V_{e0}=%5.3f\cdot10^{%2d}$cm/s, $B=%6.1f$ Gs'
...
plt.text(1.e-3,7.e-4,'Collisions',color='r',fontsize=25)
plt.text(2.8e-5,.2,'Collisions are Screened',color='r',fontsize=25)
plt.text(1.6e-5,9.e-4,'$ \cong 20\cdot R_{Crit}$',color='k',fontsize=16)
#----------------------------------------------
#
...
'''
fig205.savefig('picturesCMA/rDebye_rLikeDebye_fig205cff.jpg')    
fig207.savefig('picturesCMA/rPassrPass_fig207cff.jpg')    
fig209.savefig('picturesCMA/rDebye_rLikeDebye_rPass_fig209cff.jpg')    
fig215.savefig('picturesCMA/rMax_fig215cff.jpg')    
fig305.savefig('picturesCMA/rFast_rCrit_fig305cff.jpg')    
fig307.savefig('picturesCMA/rMin_fig307cff.jpg')    
fig315.savefig('picturesCMA/impctPrmtr_fig315cff.jpg')    
fig3151.savefig('picturesCMA/impctPrmtr_fig3151cff.jpg')    
fig320.savefig('picturesCMA/coulombLgrthm_fig320cff.jpg')    
fig3201.savefig('picturesCMA/coulombLgrthm_lin_fig3201cff.jpg')    
fig395.savefig('picturesCMA/trnsvFF_fig395cff.jpg')    
fig495.savefig('picturesCMA/longFF_fig495cff.jpg')    
fig595.savefig('picturesCMA/trnsvFF_longFF_fig595cff.jpg')    
'''
